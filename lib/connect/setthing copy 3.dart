...
import 'package:somboonqms/printerenum.dart';
...
class TestPrint {
  ...
  sample(BuildContext context, Map<String, dynamic> qrData) async {
    //image max 300px X 300px

    ///image from File path
    String filename = 'logo.png';
    ByteData bytesData = await rootBundle.load("assets/logo/logo.png");
    String dir = (await getApplicationDocumentsDirectory()).path;
    File file = await File('$dir/$filename').writeAsBytes(bytesData.buffer
        .asUint8List(bytesData.offsetInBytes, bytesData.lengthInBytes));

    ///image from Asset
    ByteData bytesAsset = await rootBundle.load("assets/logo/logo.png");
