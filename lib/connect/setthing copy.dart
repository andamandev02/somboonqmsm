...
//       // ค้นหาอุปกรณ์จากที่อยู่ใน _pairedDevices
//       foundDevice = _pairedDevices.firstWhere(
//         (device) => device.address == printerAddress,
//       );

//       // ถ้าไม่เจอใน _pairedDevices, ค้นหาใน _devicesList
//       if (foundDevice == null) {
...
//       // อัปเดต _selectedDevice ถ้าเจออุปกรณ์ที่ตรงกัน
//       if (foundDevice != null) {
//         setState(() {
...
//   // void _printMessage(BluetoothDevice device) async {
//   //   try {
...
//       // เพิ่มรูปภาพโลโก้เพียงครั้งเดียว
